...
describe('helpers -> converters', () => {
  ...
  test('can convert an API subscription status', () => {
  ...
  test('can convert an SDK subscription status', () => {
  ...
  test('can convert an API paused reason', () => {
  ...
  test('can convert an API currency', () => {
  ...
  test('can convert an API country', () => {
  ...
  test('can convert an API payment method', () => {
  ...
  test('can convert an API card type', () => {
  ...
  test('can convert an refund type', () => {
  ...
  test('can convert an SDK price list', () => {
    expect(
